			<?php
                    ...
                    $results=mysql_query("SELECT id,prodName,descript,price FROM products WHERE categoryId = '$categoryId'");
					...
					echo "</div>";
                    	...
                    	$results2=mysql_query("SELECT id,prodName,descript,price FROM products WHERE categoryId = '$categoryId'");
						...
						echo "<div class='productPreview'>";
							...
							echo "<a class='right productLink descProductPreview' id='linkProductId' href='productPage.php?productID=".$fisrtRow[0]."&crumID=".$crumID."&urlBack=".$urlBack."'>Read description</a>";
