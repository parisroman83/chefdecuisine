...
<title>Chef de Cuisine :: Admin :: Delete Item</title>
...
<div id="wrapper">
    ...
    <div id="contentBody">
        ...
        <div id="contentRight">
            ...
            <form class="backendForms" action="formDelete.php" method="post" enctype="multipart/form-data">
                <p>
                <label for="product">Product Name:</label><br />
                    ...
                    <?php
                        ...
                        echo "<SELECT id='product' name='product'><OPTGROUP label='Category'>";
